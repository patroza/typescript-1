...
export function createGetSourceFile(
    ...
    return (fileName, languageVersionOrOptions, onError) => {
        ...
        return text !== undefined ? createSourceFile(fileName, text, languageVersionOrOptions, setParentNodes, undefined, getCompilerOptions(), skipNonSemanticJSDocParsing) : undefined;
    };
}
